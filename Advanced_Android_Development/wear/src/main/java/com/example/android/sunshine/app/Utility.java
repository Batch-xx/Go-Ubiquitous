...
/**
 * Created by BKBachelor on 10/17/2016.
 */
...
public  class Utility {
    ...
    public static int DATE_COLOR_AMBIENT =  Color.parseColor("#e0e0e0");
    public static int TEMP_COLOR_INTERACTIVE =  Color.parseColor("#FFFFFF");
    public static int TEMP_COLOR_AMBIENT =  Color.parseColor("#e0e0e0");
